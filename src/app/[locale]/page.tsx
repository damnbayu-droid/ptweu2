...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generatePageMetadata({
    title: isId ? "Supplier Batu Kapur & Kalsium Karbonat Indonesia" : "Limestone & Calcium Carbonate Supplier Indonesia",
    description: isId 
      ? "PT Wira Energi Utama adalah perusahaan penyedia batu kapur (limestone) dan kalsium karbonat berkualitas tinggi untuk industri, konstruksi, dan infrastruktur di Indonesia."
      : "PT Wira Energi Utama is a supplier of high-quality limestone and calcium carbonate for industry, construction, and infrastructure in Indonesia.",
...
export default async function HomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = (key: string) => {
    ...
    let result: any = messages.HomePage;
    for (const k of keys) {
